<template>
    <div class="container py-4">
        <div v-if="inCartProducts.length" class="card-box row flex-column g-3">
            ...
            >
                <div
                    class="card shadow-sm d-flex flex-row p-3 align-items-center"
                >
                    <!-- Image section -->
                    <img
                        :src="
                    ...
                    <div class="flex-grow-1">
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    class="quantityButtons d-flex align-items-center"
                                >
                                    <button
                                        class="btn btn-outline-secondary btn-sm"
                                        @click="decreaseCount(product.id)"
                                        v-if="
                                            typeof product.countInCart !==
                                            'undefined'
                                        "
        ...
        <p v-else class="text-center mt-4 text-muted">Корзина Порожня</p>
    </div>
</template>
...
const inCartProducts = computed(() => {
    return productStore.products.filter((product) =>
        productStore.inCart.includes(product.id),
    );
});
